...
#ifndef TURTLEBOT3_GIX_HARDWARE__OPENCR_CONTROL_TABLE_HPP_
#define TURTLEBOT3_GIX_HARDWARE__OPENCR_CONTROL_TABLE_HPP_

#include <stdint.h>

#define CONTROL_TABLE_SIZE 382
...
typedef struct
{
  ...
  // gix
  ControlItem connect_gix = {346, 1};
  ControlItem torque_gix = {347, 1};

  ControlItem goal_position_gix = {348, 4};
  ControlItem goal_position_write_gix = {352, 1};

  ControlItem present_position_gix = {355, 4};
  ControlItem present_velocity_gix = {359, 4};
  ControlItem present_current_gix = {363, 2};

  ControlItem profile_acceleration_gix = {365, 4};
  ControlItem profile_acceleration_write_gix = {369, 1};

  ControlItem profile_velocity_gix = {372, 4};
  ControlItem profile_velocity_write_gix = {376, 1};

  ControlItem goal_current_gix = {379, 2};
  ControlItem goal_current_write_gix = {381, 1};
} ControlTable;
...
#endif  // TURTLEBOT3_GIX_HARDWARE__OPENCR_CONTROL_TABLE_HPP_
